...
<head>
<meta charset="UTF-8">
<title>Attendance Records | macademia Faculty</title>
...
<div class="dashboard-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo PUBLIC_URL; ?>/index.php/admindash/attendanceRecord" class="sidebar-link active"><i class="bi bi-clipboard-data"></i><span>Attendance</span></a></li>
