...
if (basename($_SERVER['SCRIPT_NAME']) !== 'index.php') {
    ...
    header('Location: ' . $base . '/index.php/studdash/profile');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['remove_photo'])) {
    $user = $mysqli->query("SELECT photo_path FROM users WHERE id = $student_id")->fetch_assoc();
    ...
    if ($_FILES['photo']['error'] === UPLOAD_ERR_OK) {
        if ($_FILES['photo']['size'] > $max_size) {
            ...
            if (move_uploaded_file($_FILES['photo']['tmp_name'], $file_path)) {
                ...
                $stmt->bind_param("si", $photo_path, $student_id);
                $stmt->execute();
...
$user = $mysqli->query("SELECT nom, prenom, email, role, photo_path FROM users WHERE id = $student_id")->fetch_assoc();
...
.btn {
    padding: 0.75rem 1.25rem; border-radius: 10px; border: none; cursor: pointer; font-weight: 600;
    transition: var(--transition);
}
...
<nav class="navbar">
    <div class="navbar-left">
        ...
        <a href="<?php echo $public_url; ?>/index.php/studdash/dashstud" class="logo">
...
<div class="dashboard-wrapper">
    <aside class="sidebar" id="sidebar">
        <ul class="sidebar-menu">
            <li><a href="<?php echo $public_url; ?>/index.php/studdash/profile" class="sidebar-link active"><i class="bi bi-person-circle"></i><span>Profile</span></a></li>
            <li><a href="<?php echo $public_url; ?>/index.php/studdash/dashstud" class="sidebar-link"><i class="bi bi-speedometer2"></i><span>Dashboard</span></a></li>
            <li><a href="<?php echo $public_url; ?>/index.php/studdash/modules" class="sidebar-link"><i class="bi bi-book"></i><span>Modules</span></a></li>
            <li><a href="<?php echo $public_url; ?>/index.php/studdash/attendance" class="sidebar-link"><i class="bi bi-clipboard-check"></i><span>Attendance</span></a></li>
            <li><a href="<?php echo $public_url; ?>/index.php/studdash/absences" class="sidebar-link"><i class="bi bi-calendar-x"></i><span>Absences</span></a></li>
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <p class="page-subtitle">Manage your personal details and profile photo</p>
        </div>
        ...
        <div class="profile-grid">
            ...
            <div class="card">
                ...
                <div class="features">
                    ...
                    <div class="feature-item"><i class="bi bi-envelope-check"></i> Your email is used for important notifications.</div>
